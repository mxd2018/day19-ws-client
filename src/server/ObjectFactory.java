...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://server/", "queryWeather");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server/", name = "queryWeather")
